...
6. Run code "Extracting Feature.ipynb" for get features from audio and you will get data array in folder "array"
7. Run code "Training_validation_test.ipynb" for training model, validation model, test model
8. If you don't want training model, you can use file "cough_01.h5" or "cough_02.h5", where it accuration is 97% and 97%
